...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        address ownerAddress1 = ownerOf(_tokenId1) == msg.sender ? msg.sender : ownerOf(_tokenId1);
        address ownerAddress2 = ownerOf(_tokenId2) == msg.sender ? msg.sender : ownerOf(_tokenId2);
